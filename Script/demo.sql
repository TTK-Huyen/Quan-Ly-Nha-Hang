	...
	--5. Tìm nhân viên 
		--THEO MÃ 
		EXEC TIMTTNV 'NV0001', '10'
		--THEO TÊN 
		EXEC sp_TimNhanVienTheoTen 'Austin Gomez' , '3'
		--THEO NGÀY SINH
		EXEC sp_TimNhanVienTheoNgaySinh  '1995-12-01', '5' SELECT * FROM LichSuLamViec WHERE MaNhanVien = 'NV0284'
		--THEO NGÀY VÀO LÀM
	...
	--12. THÊM PHIẾU ĐẶT MÓN 
		--thêm pdm
		EXEC THEMPDM 'NV0034', '34', '0965422252', '4';
		--sửa pdm
